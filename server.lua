...
local REMOTE_VERSION_URL = 'https://raw.githubusercontent.com/MrKap1/KCPv1/refs/heads/main/latest_version.txt' -- e.g., 'https://raw.githubusercontent.com/your-username/your-repo/main/latest_version.txt'
