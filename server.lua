...
local REMOTE_VERSION_URL = 'https://github.com/MrKap1/KCPv1/blob/main/latest_version.txt' -- e.g., 'https://raw.githubusercontent.com/your-username/your-repo/main/latest_version.txt'
